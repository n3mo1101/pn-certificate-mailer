...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-n16*e!ou-m9chb9*f$p_7!0=+jkr@_)7!atvru5f=t9*gs0ob^')
...
# Batch configuration
MAX_CERTIFICATES_PER_BATCH = 80
BATCH_COOLDOWN_INTERVAL = 50
